...
namespace ScreenSound.Migrations
{
    ...
    [Migration("20240529005101_RelacionandoMusicaGeneroEDiscografia")]
    partial class RelacionandoMusicaGeneroEDiscografia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiscografiaMusica", b =>
                {
                    b.Property<int>("DiscografiasId")
                        .HasColumnType("int");

                    b.Property<int>("MusicasId")
                        .HasColumnType("int");

                    b.HasKey("DiscografiasId", "MusicasId");

                    b.HasIndex("MusicasId");

                    b.ToTable("DiscografiaMusica");
                });
            ...
            modelBuilder.Entity("ScreenSound.Shared.Modelos.Modelos.Discografia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DiscografiaMusica", b =>
                {
                    b.HasOne("ScreenSound.Shared.Modelos.Modelos.Discografia", null)
                        .WithMany()
                        .HasForeignKey("DiscografiasId")
